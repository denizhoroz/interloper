        ...
        <>
            ...
            <div className="flex flex-col">
                ...
                <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-14 md:mb-30 text-[#FAFDD6] drop-shadow-lg text-center">
                        Bir Dil Seç
                    </h1>
                    <div className="bg-[#FAFDD6]/90 rounded-2xl shadow-lg p-10 mb-16 max-w-3xl w-full flex flex-col items-center">
                        <p className="text-xl sm:text-2xl md:text-3xl text-[#647FBC] font-semibold text-center leading-relaxed mb-8">
